...
- <a href="#visualizing-errors" id="toc-visualizing-errors">Visualizing
  Errors</a>
  - <a href="#basic-errorbars" id="toc-basic-errorbars">Basic Errorbars</a>
...
![](04visualizing%20errors_files/figure-gfm/cell-3-output-1.png)
...
![](04visualizing%20errors_files/figure-gfm/cell-4-output-1.png)
...
information on the options avail‐ able, refer to the docstring of
plt.errorbar. \## Continuous Errors In some situations it is desirable
to show errorbars on continuous quantities. Though Matplotlib does not
have a built-in convenience routine for this type of application, it’s
relatively easy to combine primitives like plt.plot and plt.fill_between
for a useful result.
